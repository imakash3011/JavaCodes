...
public class HeapGeneric<T extends Comparable<T>> {
    ...
    //we are writing following Hashmap to solve the Prims problem in graph
    ...
    public void add(T item){
        ...
        //we are wrting following line to solve th prims problem in graph
